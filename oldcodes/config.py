...
def queue(server, i):
	if server=='biglab':
		if i%7==1: queue='biglab4'
		elif i%7==2: queue='biglab4'
		elif i%7==3: queue='biglab4'
		elif i%7==4: queue='biglab4'
		elif i%7==5: queue='biglab4'
		elif i%7==6: queue='biglab4'
		else: queue='biglab4'
#		queue='biglab2'
#	elif server=='cngc':
#		queue='-lncpus=4'
...
# 
minIsoformFraction='0.1' #default: 0.1
minTranscriptLength='200' #default: 200
minAnchorLength='10' #default: 10
minJunctionCoverage='1' #default: 1
minReadCoverage='2.5' #default: 2.5
maxMultiCoverage='1.0' #default: 1.0
minSingleExonCoverage = '4.75' #default: 4.75

# 
gapBetweenBundle='100' #default: 50
